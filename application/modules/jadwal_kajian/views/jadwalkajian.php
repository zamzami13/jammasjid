            ...
            <div class="body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
					  	<thead>
					    	<tr>
					      		<th class="text-center th-sm">No</th>
					      		<th class="">Ustad</th>
					      		<th class="">Materi</th>
					      		<th class="text-center th-sm">Tanggal</th>
					      		<th class="text-center th-sm">Waktu</th>
					      		<th class="text-center th-sm" width="">Action</th>
					    	</tr>
					  	</thead>
					  	<tbody>
						  	<?php $no=1; foreach ($data as $key => $value) { ?>
							    <tr>
							      	...
							      	<td class="text-center">
							      		<a class="ajaxify" href="<?php echo $fullurl; ?>/edit/<?php echo $value['kajian_id']; ?>">
							      			<button class="btn btn-lg bg-orange waves-effect">Edit</button>
							      		</a>
							      		<a class="ajaxify action_delete"
							      			data-url="<?php echo $fullurl; ?>/action_delete"
							      			data-id="<?php echo $value['kajian_id']; ?>">
							      		<button class="btn btn-lg bg-red waves-effect">Hapus</button>
							      		</a>
							      	</td>
							    </tr>
						  	<?php } ?>
