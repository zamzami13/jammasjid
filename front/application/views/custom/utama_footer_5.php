<div class="row box overflow-hidden ws-container px-3 py-3 rounded-md">
    <div class="z-50 col-md-2 col-lg-2 col-xl-2 padding-0">
        ...
        <div class="waktu-shalat-b">
            <div class="waktu-shalat bg-terbit z-depth-1 text-center mx-1 my-1 rounded-md">
                <h2 class="">Terbit</h2>
    ...
    <div class="z-50 col-md-2 col-lg-2 col-xl-2 padding-0">
        ...
        <div class="waktu-shalat-b">
            <div class="waktu-shalat bg-subuh darken-3 unique z-depth-1 text-center mx-1 my-1 rounded-md">
                <h2 class="">Subuh</h2>
    ...
    <div class="z-50 col-md-2 col-lg-2 col-xl-2 padding-0">
        ...
        <div class="waktu-shalat-b">
            <div class="waktu-shalat bg-dzuhur darken-1 z-depth-1 text-center mx-1 my-1 rounded-md">
                <h2 class="">Dzuhur</h2>
    ...
    <div class="z-50 col-md-2 col-lg-2 col-xl-2 padding-0">
        ...
        <div class="waktu-shalat-b">
            <div class="waktu-shalat bg-ashar darken-3 z-depth-1 text-center mx-1 my-1 rounded-md">
                <h2 class="">Ashar</h2>
    ...
    <div class="z-50 col-md-2 col-lg-2 col-xl-2 padding-0">
        ...
        <div class="waktu-shalat-b">
            <div class="waktu-shalat bg-maghrib darken-3 z-depth-1 text-center mx-1 my-1 rounded-md">
                <h2 class="">Maghrib</h2>
    ...
    <div class="z-50 col-md-2 col-lg-2 col-xl-2 padding-0">
        ...
        <div class="waktu-shalat-b">
            <div class="waktu-shalat bg-isya darken-3 z-depth-1 text-center mx-1 my-1 rounded-md">
                <h2 class="" class="">Isya</h2>
